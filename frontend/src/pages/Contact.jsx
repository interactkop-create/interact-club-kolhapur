            ...
            <div className="space-y-6">
              ...
              <Card className="bg-primary text-primary-foreground card-hover">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-4">Join Our Club</h3>
                  <p className="mb-6 opacity-90">
                    Interested in becoming a member? We welcome young people aged 12-18 who are passionate about making a difference.
                  </p>
                  <p className="text-sm opacity-90">
                    Contact us to learn more about membership opportunities and how you can get involved with Interact Club of Kolhapur.
                  </p>
                </CardContent>
              </Card>
