...
import { LayoutDashboard, Users, Calendar, Newspaper, Image, Settings, LogOut, ClipboardList } from 'lucide-react';
       ...
       <main className="flex-1 p-6">
          ...
          <div className="mt-8 pt-6 border-t text-center">
             <p className="text-xs text-muted-foreground">
                 Made with ❤️ by Itr.Om Malani, International Service Director, Interact Club of Kolhapur, RI Year 2025-26
                 </p>
              </div>
         </main>
      </div>
